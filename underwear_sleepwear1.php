...
<html lang="en">
   <head>
      ...
      <!-- site metas -->
      <title>UNDERWEAR & SLEEPWEAR</title>
   ...
   ?>
      ...
      <div class="product_section layout_padding">
         <div class="container">
            <div class="row">
               <div class="col-sm-12">
                  <h1 class="product_taital">UNDERWEAR & SLEEPWEAR Products</h1>
            ...
            <div class="product_section_2 layout_padding">
               <div class="row">
               <?php
                $select_products = mysqli_query($conn, "SELECT * FROM `products` WHERE `category` = 'underwear&sleepwear'");
